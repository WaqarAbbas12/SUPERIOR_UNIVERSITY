...
def predict_sentiment(text):
    ...
    return inverse_label_map[predicted_class], confidence_score
...
def classify():
    ...
    text = data["text"]
    predicted_class, confidence_score = predict_sentiment(text)

    return jsonify(
        {"prediction": predicted_class, "confidence_score": float(confidence_score)}
    )
